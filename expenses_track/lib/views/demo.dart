...
class SelectionUserManagedState extends State<SelectionUserManaged> {
  ...
  void _infoSelectionModelUpdated(charts.SelectionModel<String> model) {
    ...
    // alter the selection.
//    List<charts.ImmutableSeries<String>> s = new List<charts.ImmutableSeries<String>>();
//    _myState.selectionModels[charts.SelectionModelType.info].getModel(s);
//    print(s);
    model.selectedSeries.forEach((f){
      print(f.data);
    });
  ...
  _infoSelectionModelChanged(charts.SelectionModel<String> model) {
//    model.selectedSeries.forEach((f){
//      print(f.data);
//    });
